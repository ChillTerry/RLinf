...
# Use RLinf-style video saving format (simple episode_id naming)
_C.EVAL.USE_RLINF_VIDEO_FORMAT = True
# FPS for video saving (used when USE_RLINF_VIDEO_FORMAT is True)
_C.EVAL.VIDEO_FPS = 5
# ----------------------------------------------------------------------------
# INFERENCE CONFIG
# ----------------------------------------------------------------------------
